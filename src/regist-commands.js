...
const commands = [
  {
    ...
    options: [
      ...
      },
      {
        name: 'reason',
        description:
          'State your reason. Check #📖・guide for the full list of reportable offences.',
      ...
      },
      {
        name: 'message-link',
        description:
          'Provide a link to the message that violates the rules (if applicable)',
        type: ApplicationCommandOptionType.String,
        required: false,
      },
      {
        name: 'evidence',
        description:
          'Provide evidence for the report (screenshot, video, etc.)',
  ...
  },
  {
    name: 'speak-embed',
    description:
      'Lets the user speak through the bot by sending an embed message.',
    options: [
      {
        name: 'title',
  ...
  {
    name: 'mute',
    description: 'Mute a user for misconduct of rules',
    options: [
      {
        name: 'user',
        description: 'Select the user to mute',
        type: ApplicationCommandOptionType.User,
        required: true,
      },
      {
      ...
      },
      {
        name: 'duration',
        description:
          'Specify the duration for the mute in minutes (e.g., 60 for 1 hour)',
  ...
  {
    name: 'ban',
    description: 'Ban a user for misconduct of rules',
    options: [
      {
        name: 'user',
